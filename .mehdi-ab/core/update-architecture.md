...
## Critical Step
**ALWAYS check `.mehdi-ab/structure/index.yaml` FIRST** to find where architecture files are located.
...
Based on `.mehdi-ab/structure/index.yaml` paths, check which files need updates:
- **Entity/Data changes** -> data-patterns.md, tech-stack.md, entry-points.md
- **REST API changes** -> backend-patterns.md, entry-points.md
- **Security changes** -> security-patterns.md, backend-patterns.md
- **Dependencies** -> tech-stack.md, external-services.md
- **Infrastructure** -> infrastructure.md, project-constraints.md
...
## Remember
- Never assume paths - check `.mehdi-ab/structure/index.yaml`
